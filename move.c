...
int  move_the_cell(khoneh cells[9][13],int x_source,int y_source,int x_destination,int y_destination){
    if(cells[y_source][x_source].type != 100){
        ...
        if(cells[y_source][x_source].type == 102){ //JOHN H. WAHTSON
